...
import com.isheji.project.common.utils.EncrypAES;
import com.isheji.project.common.utils.ErrorCode;
...
import com.isheji.project.entity.User;
import com.isheji.project.entity.WiselyResponse;
import com.isheji.project.service.UserService;
import com.isheji.project.service.ValidationService;
import com.isheji.project.service.WebSocketService;
...
/*    @Resource
    ...
    public Msg register(User req) {
        ...
        int re = userService.register(username, password, mail);
        switch (re) {
            case 0:
